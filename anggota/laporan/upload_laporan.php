...
// Ambil data laporan dari database berdasarkan id laporan
        ...
        <div class="card border-top border-0 border-4 border-warning">
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <?php 
                    // Hitung jumlah foto dan video yang sudah diupload untuk laporan ini
                    ...
                    // Jika sudah ada foto atau video terkait laporan ini, tampilkan pesan sukses
                    if ($data_foto > 0 OR $data_video > 0) { ?>
                        <button type="button" class="btn btn-success px-2" onClick="window.location.href = 'index.php?page=riwayat_laporan';"><i class='bx bx-check mr-1'></i> Berhasil Mengirimkan Laporan, Check Riwayat Laporan</button>
                    <?php } else {
