...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Laporan Warga</div>
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                <li class="breadcrumb-item"><a href="index.php?page=dashboard"><i class="bx bx-home-alt"></i></a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Laporan Warga</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="">
    <div class="">
        <div class="container py-2">
            <h2 class="font-weight-light text-center text-muted py-3">Laporan Warga</h2>
            <?php
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse border" id="t2_details<?= $data['id_laporan']?>">
                                <div class="p-2 text-monospace">
                                    ...
                                    <div>Pelapor : <b><?= strtoupper($data['nama']).' - '.$data['nik'] ?></b></div>
                                    <hr>
                                    <div>Foto : </div>
                                    <div>
                                        <?php
