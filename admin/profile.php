...
<div class="container">
    <?php
    include "../conn/conn.php"; // Sertakan file koneksi ke database

    // Ambil informasi profile pengguna berdasarkan session
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="../assets/images/<?= $data_profile['jenis_kelamin'] == "laki-laki" ? "emale.png" : "woman.png" ?>" alt="Admin" class="rounded-circle p-1 bg-warning" width="110">
                            <div class="mt-3">
                                <h4><?= ucwords($data_profile['nama']) ?></h4>
                                <p class="text-secondary mb-1"><b><?= $data_profile['nik'] ?></b></p>
                                <p class="text-muted font-size-sm"><?= strtoupper($data_profile['alamat']) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <div class="input-group" id="show_hide_password">
                                        <input type="password" name="pass" class="form-control border-end-0" id="inputChoosePassword" placeholder="Enter Password">
